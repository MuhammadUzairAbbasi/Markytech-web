...
const Cubes: React.FC<CubesProps> = ({
  ...
  const gridRows = gridSize.row
  const gridCols = gridSize.col
  ...
  const onClick = useCallback(
    ...
    [rippleOnClick, gridRows, gridCols, faceColor, rippleColor, rippleSpeed]
  )
  ...
  }, [autoAnimate, gridRows, gridCols, tiltAt])
